...
Source0  : https://download.geany.org/geany-2.0.tar.gz
Source1  : https://download.geany.org/geany-2.0.tar.gz.sig
Source2  : 24CCD8550E5D1CAE.pkey
...
grep -E '^\[GNUPG:\] (GOODSIG|EXPKEYSIG) 24CCD8550E5D1CAE' gpg.status
%setup -q -n geany-2.0
cd %{_builddir}/geany-2.0
pushd ..
cp -a geany-2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713290852
...
cp %{_builddir}/geany-%{version}/COPYING %{buildroot}/usr/share/package-licenses/geany/1bba544d91de647b97f45a31e63540d6d5d06096 || :
export GOAMD64=v2
GOAMD64=v3
pushd ../buildavx2/
%make_install_v3
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/geany/classbuilder.so
/V3/usr/lib64/geany/export.so
/V3/usr/lib64/geany/filebrowser.so
/V3/usr/lib64/geany/htmlchars.so
/V3/usr/lib64/geany/saveactions.so
/V3/usr/lib64/geany/splitwindow.so
/V3/usr/lib64/libgeany.so.0.0.0
